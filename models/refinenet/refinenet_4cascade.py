...
from models.refinenet.blocks import (
    RefineNetBlock,
    ResidualConvUnit,
...
class BaseRefineNet4Cascade(nn.Module):
    ...
    def __init__(self, input_shape,
        ...
        self.refinenet2 = RefineNetBlock(features, (features, input_size // 8), (features, input_size // 4))
        self.refinenet1 = RefineNetBlock(features, (features, input_size // 4), (features, input_size // 2))
    ...
    def forward(self, x):
        ...
        out = nn.Upsample(scale_factor=4, mode='bilinear', align_corners=True)(out)
