...
def train_transforms(image, masks):
    ...
    image_aug_tensor = transforms.Normalize([0.646311050624383, 0.5215321518722066, 0.8275685641750257],
                                            [0.646311050624383, 0.5215321518722066, 0.8275685641750257])(image_aug_tensor)
